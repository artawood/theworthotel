...
<html lang="en">
  <head>
    ...
    <title>The Worth Hotel | ติดต่อ</title>
  ...
  <body class="thai-font">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav nav-bottom mr-auto">
          <li class="nav-item nav-space mobile-nav">
            <a class="nav-link thai-nav" href="rooms.html" lang="th">ห้อง</a>
          </li>
          <li class="nav-item nav-space mobile-nav">
            <a class="nav-link thai-nav" href="gallery.html" lang="th">รูปภาพ</a>
          </li>
          <li class="nav-item nav-space mobile-nav">
            <a class="nav-link thai-nav" href="about.html" lang="th">เกี่ยวกับ</a>
          </li>
          <li class="nav-item nav-space mobile-nav">
            <a class="nav-link thai-nav" href="contact.php" lang="th">ติดต่อ</a>
          </li>
        </ul>
          <ul class="navbar-nav mr-auto thai-eng">
            <li class="nav-item mobile-nav text-center">
              <a href="#"><img class="flag" src="../images/header/flag-thai.png" alt="Thai Flag"></a>
              <a class="nav-link flag-thai-text" href="#" lang="th">ไทย</a>
            </li>
            <li class="nav-item mobile-nav text-center">
              <a href="../contact.php"><img class="flag" src="../images/header/flag-eng.png" alt="American Flag"></a>
              <a class="nav-link flag-eng-text" href="../contact.php">ENG</a>
            </li>
    ...
    <div class="jumbotron contact-header">
      <div class="container page-header">
        <h1 class="thai-page-header" lang="th">ติดต่อ</h1>
      </div>
    </div>
      ...
      <div class="row featurette">
        <div class="col-lg-5 order-lg-1">
          <div class="container contact-info">
            <h3 class="contact-title" style="font-weight: 900;">ที่อยู่</h3>
            <p class="lead"><address>The Worth Hotel<br>641 Post St.<br>San Francisco, CA 94109</address></p>
          </div>
          <div class="container contact-info">
            <h3 class="contact-title" style="font-weight: 900;">ข้อมูลติดต่อ</h3>
            <p style="font-weight: 900;">โทรศัพท์: <a href="tel:+14157753940" style="color: #000000; font-weight: 900;"> (415) 775 - 3940</a> <br>อีเมลล์: <a href="mailto:info@theworthhotel.com" style="color: #000000;  font-weight: 900;"> info@theworthhotel.com</a></p>
          </div>
        </div>
        ...
        <div class="form-row">
            <div class="col-md-6">
              <div class="form-group">
                <input type="text" class="form-control" id="formGroupExampleInput" name="name1" placeholder="ชื่อ" required>
                <div class="invalid-feedback">กรุณาใส่ชื่อ</div>
              </div>
              <div class="form-group">
                <input type="text" class="form-control" id="formGroupExampleInput" name="name2" placeholder="นามสกุล" required>
                <div class="invalid-feedback">กรุณาใส่นามสกุล</div>
              </div>  
              <div class="form-group">
                <input type="email" class="form-control" id="formGroupExampleInput" name="email" placeholder="อีเมลล์" required>
                <div class="invalid-feedback">กรุณาใส่อีเมลล์ที่ถูกต้อง</div>
              </div>
              <div class="form-group">
                <select class="form-control" name="subject" id="contact-about" required>
                  <option value="" selected disabled style="color:#BBBBBB">ติดต่อเรื่อง</option> 
                  <option lang="th">การให้เช่า</option>
                  <option lang="th">สอบถามทั่วไป</option>
                </select>
                <div class="invalid-feedback">กรุณาเลือกเรื่องติดต่อ</div>
              </div>    
            </div>

          <div class="col-md-6">
            <div class="form-group">
            <textarea class="form-control message-box" id="exampleFormControlTextarea1" rows="9" name="message" placeholder="ข้อความ" required></textarea>
            <div class="invalid-feedback">กรุณาใส่ข้อความ</div>
            </div>
            <div class="form-group"><button type="submit" class="btn btn-secondary thai-p" style="float: right;">ส่งการติดต่อ</button></button></div>
          </div>
        </div>
        <?php
			if (isset($_POST['email'])) {
					...
					$email = $_POST['email'];
					$message = 'จาก: '.$_POST['name1']." ".$_POST['name2']."\n\n";
					$message .= 'อีเมลล์: '.$_POST['email']."\n\n";
					$message .= 'ติดต่อเรื่อง: ' .$_POST['subject']."\n\n";
					$message .= 'ข้อความ: '."\n\n".$_POST['message']."\n\n";
					$subject2 = 'อีเมลยืนยันจาก The Worth Hotel';
					$message2 = 'สวัสดีคุณ ' .$_POST['name1'].','."\n\n";
					$message2 .= 'นี่เป็นการยืนยันว่าเราได้รับข้อมูลจากคุณแล้ว เราจะตอบกลับคุณเร็ว ๆ นี้'."\n\n";
					$message2 .= 'หากอีเมลนี้ถูกส่งไปหาคุณไม่ถูกต้องโปรดส่งอีเมลไปที่ info@theworthhotel.com เพื่อแจ้งให้เราทราบ'."\n\n";
					$message2 .= 'ขอบคุณมาก'."\n\n";
					$message2 .= '_______________________________________________________________________________________________________'."\n\n";
					$message2 .= 'ข้อความของคุณ: '."\n\n";
					$message2 .= 'ติดต่อเรื่อง: '.$_POST['subject']."\n\n";
